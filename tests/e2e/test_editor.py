...
from helpers import HEADER, OUT, at_menu, make, need_display, start_editor, status_line
...
class EditorTests(unittest.TestCase):
    ...
    def test_01_menu(self):
        ...
        self.assertEqual(lines[7], "6 SCROLLTEXT (0/5118)")
        self.assertEqual(lines[9], "8 SAVE")
    ...
    def test_05_scrolltext_editing(self):
        ...
        self.back_to_menu()
        self.assertEqual(v.screen_text(8)[7], "6 SCROLLTEXT (9/5118)")
